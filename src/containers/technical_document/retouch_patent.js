	...
	return(
		<div className="page-wrap">
			<div className="board- board-add document- technical-document-add">
				...
				<DropsMenu datas={drop_datas} default={typeCd == 'P' ? "특허" : typeCd == 'T' ? '논문' : '보고서'} setState={setTypeCd}/>
				...
				<div className="content- content-2">
					...
					<div className="flex_ input-search box-">
						<Input labelText="소속" placeholder="소속을 검색해 주세요." valueType="" helperTextResult="none" iconState="false" state={orgn} setState={setOrgn}/>
