		...
		<div className="page-wrap">
			<div className="board- board-add document- technical-document-add">
				...
				<div className="content- content-2">
					...
					<div className="box-">
						<Input importState="none" labelText="출원번호" placeholder="출원번호를 입력해 주세요." helperTextResult="none" iconState="false"/>
					</div>

					<div className="box-">
						<Input importState="none" labelText="등록번호" placeholder="등록번호 입력해 주세요." helperTextResult="none" iconState="false"/>
					</div>
