...
const Component = () => {
	...
	const TabContentA = () => {
		...
		return(
			<div className="sub-page-0 sub-page">
				<TextArea labelText="사이트 소개" placeholder="이용 약관을 입력해 주세요." valueType="" helperTextResult="none"/>
				<ButtonSecondaryS text="예시 불러오기" setButton={setButton}/>

				<div className={`flex_ tip-text-box txt-second-default radius-8 bg-violet-6 ${isButton? 'show' : ''}`}>
	...
	const TabContentB = () => {
		...
		return(
			<div className="sub-page-0 sub-page">
				<TextArea labelText="개인정보처리방침" placeholder="개인정보처리방침을 입력해 주세요." valueType="" helperTextResult="none"/>
				<ButtonSecondaryS text="예시 불러오기" setButton={setButton}/>
	...
	const TabContentC = () => {
		...
		return(
			<div className="sub-page-0 sub-page">
				<TextArea labelText="개인정보 수집 및 이용에 대한 동의(회원 가입)" placeholder="개인정보 수집 및 이용에 대한 동의(회원 가입)을 입력해 주세요." valueType="" helperTextResult="none"/>
				<ButtonSecondaryS text="예시 불러오기" setButton={setButton}/>
	...
	const TabContentD = () => {
		...
		return(
			<div className="sub-page-0 sub-page">
				<TextArea labelText="개인정보 수집 및 이용에 대한 동의 (게시판)" placeholder="개인정보 수집 및 이용에 대한 동의 (게시판)을 입력해 주세요." valueType="" helperTextResult="none"/>
				<ButtonSecondaryS text="예시 불러오기" setButton={setButton}/>
	...
	const TabContentE = () => {
		...
		return(
			<div className="sub-page-0 sub-page">
				<TextArea labelText="광고성 정보 수신동의" placeholder="광고성 정보 수신동의" valueType="" helperTextResult="none"/>
				<ButtonSecondaryS text="예시 불러오기" setButton={setButton}/>
	...
	const TabContentF = () => {
		...
		return(
			<div className="sub-page-0 sub-page">
				<TextArea labelText="개인정보제공 설정" placeholder="개인정보제공 설정" valueType="" helperTextResult="none"/>
				<ButtonSecondaryS text="예시 불러오기" setButton={setButton}/>
