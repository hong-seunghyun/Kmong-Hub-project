	...
	const TabContents = () => {
		...
		return(
			<div className="sub-page-0">
				<Input importState="none" labelText="기본 도메인설정" placeholder="기본 도메인을 입력해 주세요." valueType="" helperTextResult="none" iconState="false"/>
				<div className="flex_ button-input">
					<Input importState="none" labelText="개인 도메인" placeholder="기본 도메인을 입력해 주세요." valueType="" helperTextResult="none" iconState="false"/>
