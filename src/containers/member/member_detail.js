    ...
    <div className="container">
      <div className="page-wrap">
        <div className="member- member-detail">
          <h1 className="display-5-B title">[회원 이름]</h1>
          ...
          <table className="table-horizontal-container radius-20 body-3-R">
            <tbody>
              <tr>
                ...
                <td className="tbody">도윤호</td>
              </tr>
              <tr>
                <th className="thead ">이메일</th>
                <td className="tbody">kotech@kotech.co.kr</td>
              </tr>
              <tr>
                <th className="thead ">가입일</th>
                <td className="tbody">YYYY.MM.DD</td>
              </tr>
              <tr>
                <th className="thead ">휴대폰 번호</th>
                <td className="tbody">01012345678</td>
              </tr>
              <tr>
                <th className="thead ">최근 접속일</th>
                <td className="tbody">YYYY.MM.DD HH:MM:SS</td>
              </tr>
            </tbody>
          </table>
          ...
          <table className="table-horizontal-container radius-20 body-3-R">
            <tbody>
              <tr>
                ...
                <td className="tbody">서울특별시 종로구 청와대로 1</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="tbody">남</td>
              </tr>
              <tr>
                <th className="thead ">회사명</th>
                <td className="tbody">성휘예대학교</td>
              </tr>
              <tr>
                <th className="thead ">사업 분야</th>
                <td className="tbody">AR/VR, 버츄얼</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="tbody">관심 기술 분야, 관심 기술 분야</td>
              </tr>
            </tbody>
          </table>
