...
import { getDormantMemberList } from "../../asset/apis/memberApis";
    ...
    <div className="page-wrap">
      <div className="member- ">
        <div className="head-wrap flex_">
          <h1 className="display-5-B">휴먼 회원 관리</h1>
        </div>
            ...
            {memberList &&
              memberList.map((e, idx) => (
                <TableCell
                  ...
                  listLink={`/member/inactive_member_detail/${e.siteMbrNo}`}
                />
              ))}
            <Pagnation
              size="regular"
