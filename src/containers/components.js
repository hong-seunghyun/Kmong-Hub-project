...
import ButtonPrimaryS from "/src/components/buttons/button_primary_s";
import ButtonPrimaryM from "/src/components/buttons/button_primary_m";
import ButtonPrimaryL from "/src/components/buttons/button_primary_l";
...
import ButtonSecondaryM from "/src/components/buttons/button_secondary_m";
import ButtonSecondaryL from "/src/components/buttons/button_secondary_l";
import ButtonSecondaryXL from "/src/components/buttons/button_secondary_xl";
import ButtonOutlineS from "/src/components/buttons/button_outline_s";
import ButtonOutlineM from "/src/components/buttons/button_outline_m";
...
import ButtonErrorS from "/src/components/buttons/button_error_s";
import ButtonErrorM from "/src/components/buttons/button_error_m";
...
import TextButtonUnderlinePrimaryM from "/src/components/buttons/text_button_underline_primary_m";
import TextButtonUnderlinePrimaryL from "/src/components/buttons/text_button_underline_primary_l";
import TextButtonUnderlinePrimaryXL from "/src/components/buttons/text_button_underline_primary_xl";
import TextButtonUnderlineS from "/src/components/buttons/text_button_underline_s";
import TextButtonUnderlineM from "/src/components/buttons/text_button_underline_m";
import TextButtonUnderlineL from "/src/components/buttons/text_button_underline_l";
import TextButtonUnderlineXL from "/src/components/buttons/text_button_underline_xl";
import TextButtonPrimaryS from "/src/components/buttons/text_button_primary_s";
import TextButtonPrimaryM from "/src/components/buttons/text_button_primary_m";
import TextButtonPrimaryL from "/src/components/buttons/text_button_primary_l";
import TextButtonPrimaryXL from "/src/components/buttons/text_button_primary_xl";
import TextButtonS from "/src/components/buttons/text_button_s";
import TextButtonM from "/src/components/buttons/text_button_m";
import TextButtonL from "/src/components/buttons/text_button_l";
import TextButtonXL from "/src/components/buttons/text_button_xl";
import DropsMenu from "/src/components/dropsMenu/drops_menu";
import SearchBar from "/src/components/searchBar/search_bar";
import Icon from "/src/components/icon/icon.tsx";
import SnackBar from "/src/components/snackBar/snackBar";
import Label from "/src/components/label/label";
import Badge from "/src/components/label/badge";
import Pagnation from "/src/components/pagnation/pagnation";
import TabFixed from "/src/components/tabs/tab_fixed";
import TabScrollable from "/src/components/tabs/tab_scrollable";
import InputEmail from "/src/components/textFields/textInput.tsx";
...
import TableHorizontal from "/src/components/table/table_horizontal";
      ...
      <div style={{ margin: "20px" }}>
        ...
        <div style={{ margin: "20px" }}>
          ...
          <div style={{ display: "flex", gap: "20px" }}>
            ...
            >
              <Label
                backgroundColor="bg-wrong-red-hover"
                fontColor="txt-white"
                text="label"
                icon="true"
                iconColor="#FFFFFF"
        ...
        <div style={{ margin: "20px", paddingBottom: "100px" }}>
          ...
          <InputEmail
            ...
            placeholder="이메일을 입력해 주세요"
            valueType="error"
            helperTextResult="helperB"
          />
          <InputEmail
            labelText="이메일"
            placeholder="이메일을 입력해 주세요"
            valueType="success"
            helperTextResult="helperC"
          />
        ...
        <div style={{ margin: "20px" }}>
          ...
          >
            <img
              src="/images/waitingForApproval_s.png"
              alt="waitingForApproval_s"
            />
          ...
          >
            <img
              src="/images/waitingForApproval_l.png"
              alt="waitingForApproval_l"
            />
