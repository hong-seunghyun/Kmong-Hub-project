...
const Component = () => {
  ...
  const getSite = async () => {
    await getSiteInfo()
      .then((res) => {
        console.log("site Info : ", res.data.data);
              ...
              <div>
                ...
                <div className="content_ content-1 txt-second-defalut">
                  <div className="body-2-R flex_">
                    <p>전체</p>
                    <p>
                      <span className="txt-primary">{siteInfo.allMbrNum}</span>
                      명
                    </p>
                  </div>
                  ...
                  <div className="body-2-R flex_">
                    <p>신규</p>
                    <p>
                      <span className="txt-violet-1">{siteInfo.newMbrNum}</span>
                      명
                    </p>
                  </div>
              ...
              <div>
                ...
                <div className="content_ content-1 txt-second-defalut">
                  <div className="body-2-R flex_">
                    <p>기술이전</p>
                    <p>
                      <span className="txt-violet-1">{siteInfo.ttfNum}</span>건
                    </p>
                  </div>
                  ...
                  <div className="body-2-R flex_">
                    <p>행사</p>
                    <p>
                      <span className="txt-violet-1">{siteInfo.evenNum}</span>건
                    </p>
                  </div>
                  ...
                  <div className="body-2-R flex_">
                    <p>지원사업</p>
                    <p>
                      <span className=" txt-violet-1">{siteInfo.spjNum}</span>건
                    </p>
                  </div>
                  ...
                  <div className="body-2-R flex_">
                    <p>뉴스</p>
                    <p>
                      <span className=" txt-violet-1">{siteInfo.nwsNum}</span>건
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="content_ content-1 txt-second-defalut">
                  <div className="body-2-R flex_">
                    <p>특허</p>
                    <p>
                      <span className="txt-violet-1">{siteInfo.patentNum}</span>
                      건
                    </p>
                  </div>
                  ...
                  <div className="body-2-R flex_">
                    <p>논문</p>
                    <p>
                      <span className="txt-violet-1">{siteInfo.thesisNum}</span>
                      건
                    </p>
                  </div>
              ...
              <div>
                ...
                <div className="content_ content-1 txt-second-defalut">
                  <div className="body-2-R flex_">
                    <p>전체</p>
                    <p>
                      <span className="txt-violet-1">{siteInfo.allBbsNum}</span>
                      건
                    </p>
                  </div>
                  ...
                  <div className="body-2-R flex_">
                    <p>신규</p>
                    <p>
                      <span className="txt-violet-1">{siteInfo.newBbsNum}</span>
                      건
                    </p>
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="content_ content-1 txt-second-defalut">
                  <div className="body-2-R flex_">
                    <p>전체</p>
                    <p>
                      <span className="txt-primary">{siteInfo.allIqryNum}</span>
                      건
                    </p>
                  </div>
