    ...
    <div className="container">
      <div className="page-wrap">
        <div className="contents- contents-technology inquiry- inquiry-detail">
          ...
          <table className="table-horizontal-container radius-20 body-3-R">
            <tbody>
              <tr>
                ...
                <td className="tbody">문의 제목입니다.</td>
              </tr>
              <tr>
          ...
          <TextArea
            labelText=""
            placeholder="공무원의 직무상 불법행위로 손해를 받은 국민은 법률이 정하는 바에 의하여 국가 또는 공공단체에 정당한 배상을 청구할 수 있다. 이 경우 공무원 자신의 책임은 면제되지 아니한다."
            valueType=""
