			...
			<div className="sub-page-0">
				...
				<div>
					...
					<div className="input-wrap">
						<Input labelText="메뉴명" placeholder="카테고리 제목을 입력해 주세요." valueType="menu" helperTextResult="none" iconState="false"/>
					...
					<div className="input-wrap">
						<Input labelText="한줄 소개" placeholder="" inputCountState="countShow" maxLength={8} valueType="" helperTextResult="none" iconState="false"/>
						<span className="flex_ radio-wrap">
							<Radio label="노출" name="radio-1" id="radio-a"/>
							<Radio label="미노출" name="radio-1" id="radio-b"/>
						</span>
