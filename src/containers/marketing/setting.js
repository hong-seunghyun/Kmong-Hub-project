    ...
    return (
      <div className="sub-page-0">
        <div className="title-box">
          <h2 className="heading-2-B">서류 제출 방법</h2>
        ...
        <div className="content- radius-20 bg-lightGray">
          ...
          <div className="content-text">
            ...
            <p className="body-3-R txt-second-default flex_">
              <Icon icon="checkNone" size={7} color="#574AFF" stroke="none" />
              휴대폰번호 및 유선번호와 통신서비스 이용증명원{" "}
              <span className="txt-violet-1">(발급한지 1개월 이내)</span>
            </p>
            <p className="body-3-R txt-second-default flex_">
              <Icon icon="checkNone" size={7} color="#574AFF" stroke="none" />
              SENS 대리 등록 위임장
            ...
            <p className="body-3-R txt-third flex_ ps-txt">
              <span className="dot" />
              서류 제출 시, 개인정보보호를 위해 주민등록번호 등의 개인정보가
              포함된 부분은 마스킹 처리해 주세요.
            </p>
          </div>
        </div>
        ...
        <div className="content- radius-20 bg-lightGray">
          ...
          <div className="content-text">
            <p className="body-3-R txt-second-default flex_">
              필요 서류를 첨부하여{" "}
              <span className="txt-violet-1 underline-">
                {" "}
                jee-yk@kotechmarket.com{" "}
              </span>{" "}
              로 이메일을 발송해 주세요.
            </p>
          </div>
    ...
    <div className="container">
      <div className="page-wrap">
        <div className="marketing-contents markerting-setting">
          <h1 className="display-5-B flex_">마케팅 설정</h1>
          <Tab active={0} />
          <TabContents />
        </div>
      </div>
