      ...
      >
		...
		*/}
        <div className="primary-btn btn-box">
          <ButtonPrimaryXL
            text={(props.label || [])[0]?.text ? props.label[0].text : ""}
            onclick={
              (props.label || [])[0]?.onClick
                ? props.label[0].onClick
                : () => {}
            }
          />
        ...
        <div className="error-btn btn-box">
          <ButtonErrorXL
            text={(props.label || [])[1]?.text ? props.label[1].text : ""}
            onclick={
              (props.label || [])[1]?.onClick
                ? props.label[1].onClick
                : () => {}
            }
          />
        ...
        <div className="outline-btn btn-box">
          <ButtonOutlineXL
            text={(props.label || [])[2]?.text ? props.label[2].text : ""}
            onclick={
              (props.label || [])[2]?.onClick
                ? props.label[2].onClick
                : () => {}
            }
          />
