...
const Component = (props) => {
  ...
  return (
		<div className={`date-picker-container date-picker-container-single date-picker-container-single-time flex_ radius-8 ${props.state} ${props.date}`}>
			<input value={dayjs(startDate).format('YYYY.MM.DD.HH:MM')} onClick={onCalender}/>
					...
					<div className="time-wrap flex_">
						<div className="time-box h-box flex_">
							<div className="increaseBtn btn-box" onClick={onIncreasBtnHour}>
								...
								<input type="text"  min="0" max="23" value={resultDateHour} onChange={onChangeHour}/>
						...
						<div className="time-box m-box flex_">
							<div className="increaseBtn btn-box" onClick={onIncreasBtnMin}>
								...
								<input type="text"  min="0" max="59" value={resultDateMin} onChange={onChangeMin}/>
							<div className="decreaseBtn btn-box">
								<Icon icon="chevronDown" size={5} color="#464749" stroke='' />
							</div>
						</div>
