...
const Component = (props) => {
  ...
  return (
    <div
      className={`date-picker-container flex_ radius-8 ${props.state} ${props.date}`}
    >
      <input
      ...
      >
        <div className="pick-date-wrap flex_ body-3-R">
          <h6 className="body-2-B">시간 설정</h6>
        ...
        <div className="calender-btn-wrap flex_ caption-R">
          <div onClick={onClickClose} className="radius-8 txt-second close-btn">
            취소
          </div>
          <div
            onClick={onClickSubmit}
            className={`radius-8 submit-btn ${btnActive ? "active" : ""}`}
          >
            선택 완료
          </div>
        </div>
