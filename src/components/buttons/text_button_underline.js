...
const Component = () => {
	...
	const TextButtonUnderlineS = () => {
		return(
		<button className={`btn_ btn_text txt-second caption-R ${isButton ? 'pressed' : ''}`} onClick={onClickActive} >
	...
	const TextButtonUnderlineM = () => {
		return(
		<button className={`btn_ btn_text txt-second body-3-R ${isButton ? 'pressed' : ''}`} onClick={onClickActive} >
			<span className="flex_">
				<Icon size={8.3} color='inherit' stroke='inherit' icon='plus' />
				label 
				<Icon size={9} color='inherit' stroke='inherit' icon='chevronRight' />
	...
	const TextButtonUnderlineL = () => {
		return(
		<button className={`btn_ btn_text txt-second body-2-R ${isButton ? 'pressed' : ''}`} onClick={onClickActive} >
			<span className="flex_">
	...
	const TextButtonUnderlineXl = () => {
		return(
		<button className={`btn_ btn_text txt-second body-1-R ${isButton ? 'pressed' : ''}`} onClick={onClickActive} >
			<span className="flex_">
				<Icon size={11.6} color='inherit' stroke='inherit' icon='plus' />
					label 
				<Icon size={13} color='inherit' stroke='inherit' icon='chevronRight' />
