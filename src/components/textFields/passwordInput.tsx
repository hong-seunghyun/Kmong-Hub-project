  ...
  return (
    <div className="text-fields-wrap">
      ...
      <div className={`input-container ${valueType} ${iconState}`}>
        <div
          className={`wrap radius-8 bg-lightGray ${light && `border-${light}`}`}
        >
          <svg
          ...
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M10 5.5002H2C1.55817 5.5002 1.2 5.85837 1.2 6.3002V11.3002C1.2 11.742 1.55817 12.1002 2 12.1002H10C10.4418 12.1002 10.8 11.742 10.8 11.3002V6.3002C10.8 5.85837 10.4418 5.5002 10 5.5002ZM2 4.3002C0.895431 4.3002 0 5.19563 0 6.3002V11.3002C0 12.4048 0.895431 13.3002 2 13.3002H10C11.1046 13.3002 12 12.4048 12 11.3002V6.3002C12 5.19563 11.1046 4.3002 10 4.3002H2Z"
              fill="#B3B6B8"
            />
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M5.4 10.3002V7.3002H6.6V10.3002H5.4Z"
              fill="#B3B6B8"
            />
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M5 1.9002C4.77909 1.9002 4.6 2.07928 4.6 2.3002V4.3002H3.4V2.3002C3.4 1.41654 4.11634 0.700195 5 0.700195H7C7.88366 0.700195 8.6 1.41654 8.6 2.3002V4.3002H7.4V2.3002C7.4 2.07928 7.22091 1.9002 7 1.9002H5Z"
              fill="#B3B6B8"
            />
          </svg>
          <input
