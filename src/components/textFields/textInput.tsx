			...
			<div className={`input-container ${valueType} ${iconState}`} >
				<div className="wrap radius-8 bg-lightGray">
					<svg className="icon-email" width="12" height="10" viewBox="0 0 12 10" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<path fillRule="evenodd" clipRule="evenodd" d="M5.00049 5.46877L0.625183 1.96852L1.37482 1.03148L5.75012 4.53172C5.89621 4.64859 6.10379 4.64859 6.24988 4.53172L10.6252 1.03148L11.3748 1.96852L6.99951 5.46877C6.41516 5.93625 5.58484 5.93624 5.00049 5.46877Z" fill="#B3B6B8"/>
					</svg>
					<input
